...
try {
  await q(
    supabase.from("events").upsert({
      ...
      city: "San Francisco",
      venue: "1515 3rd Street, San Francisco, CA 94158",
  ...
  await q(
    supabase.from("travel_items").insert([
      ...
      },
      {
        ...
        notes: "Private dinner after the summit. Questions: iyoya@openai.com",
        links: {
          map: "https://maps.google.com/?q=25+Lusk+St,+San+Francisco,+CA+94107",
          uber: "https://m.uber.com/ul/?action=setPickup&pickup=my_location&dropoff[formatted_address]=25%20Lusk%20St%20San%20Francisco%20CA%2094107",
        },
      },
    ]),
    "travel_items.insert",
    ...
    supabase.from("agenda_items").insert([
      {
        ...
        location: "1515 3rd Street, Mission Bay",
        start_at: "2026-03-03T20:00:00.000Z",
        end_at: "2026-03-03T21:15:00.000Z",
        description: "Lunch starts at 12:00 PM. Programming starts promptly at 1:15 PM.",
        speaker_ids: [],
      },
      {
        id: "ag_2",
      ...
      },
      {
        ...
        start_at: "2026-03-04T02:30:00.000Z",
        end_at: "2026-03-04T05:00:00.000Z",
        description: "Private dinner following the Healthcare Summit. Questions: iyoya@openai.com",
        speaker_ids: [],
      },
    ]),
    "agenda_items.insert",
  ...
  await q(
    supabase.from("executive_briefs").upsert({
      ...
      meeting_focus:
        "Timing: 12:00 PM - 6:30 PM PT. Lunch begins at 12:00 PM, and programming starts promptly at 1:15 PM. Arrivals/check-in occur at the 1515 3rd Street lobby.",
      watchouts: [
        "Parking is limited. Use public transit or rideshare when possible.",
        "Recommended rideshare drop-off and pick-up is 150 Warriors Way (not the 1515 3rd Street lobby).",
        "Bring a government-issued photo ID for lobby check-in at 1515 3rd Street.",
        "Private dinner is at 25 Lusk St from 6:30-9:00 PM PT. Questions: iyoya@openai.com",
      ],
      suggested_questions: [
